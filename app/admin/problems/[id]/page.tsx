		...
		<div>
			...
			<form action={onSubmitAction}>
				...
				<input
					...
					id="name"
					name="name"
					defaultValue={problem[0].name}
				/>
				<label htmlFor="problem">Problem</label>
				<textarea
					id="problem"
					name="problem"
					defaultValue={problem[0].problem ?? ""}
				/>
				<label htmlFor="subjectId">Subject</label>
				<select
					id="subjectId"
					name="subjectId"
					defaultValue={problem[0].subjectId}
				>
				...
				<input
					...
					name="is_active"
					value="true"
					defaultChecked={problem[0].is_active}
				/>
				<label htmlFor="solution">Solution</label>
				<textarea
					id="solution"
					name="solution"
					defaultValue={problem[0].solution ?? ""}
				/>
				...
				<input
					...
					value="true"
					defaultChecked={problem[0].solution_is_present}
				/>
				...
				<input
					...
					value="true"
					defaultChecked={problem[0].solution_is_verified}
				/>
